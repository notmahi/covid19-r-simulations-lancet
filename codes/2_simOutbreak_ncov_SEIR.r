...
for(sim in 1:nsim)
{
  ...
  epi_baseDurInf3[[sim]] = simulateOutbreakSEIR(R0t =R0est[sim] ,rho = rep(0.5,3660),dateEndIntenseIntervention = as.Date('2020-04-04'),pWorkOpen = c(0.1,0.75,1,1),
                                                numWeekStagger = c(10/7,10/7,10/7),pInfected=initialI,durInf = durInfSim)
  epi_aprilDurInf3[[sim]] = simulateOutbreakSEIR(R0t =R0est[sim] ,rho = rep(0.5,3660),dateEndIntenseIntervention = as.Date('2020-03-26'),
                                             pInfected=initialI,durInf = durInfSim)
  epi_mayDurInf3[[sim]] = simulateOutbreakSEIR(R0t =R0est[sim] ,rho = rep(0.5,3660),dateEndIntenseIntervention = as.Date('2020-05-26'),
                                             pInfected=initialI,durInf = durInfSim)
...
covid_SDurInf3[[3]] = summariseSimulations(VAR = 'S',CI = 50,SIMS = epi_aprilDurInf3)
covid_SDurInf3[[4]] = summariseSimulations(VAR = 'S',CI = 50,SIMS = epi_mayDurInf3)
...
covid_IDurInf3[[3]] = summariseSimulations(VAR = 'incidence',CI = 50,SIMS = epi_aprilDurInf3)
covid_IDurInf3[[4]] = summariseSimulations(VAR = 'incidence',CI = 50,SIMS = epi_mayDurInf3)
...
peaktime_DurInf3[[3]] = summarisePeakTimePeakSize(SIMS = epi_aprilDurInf3)
peaktime_DurInf3[[4]] = summarisePeakTimePeakSize(SIMS = epi_mayDurInf3)
...
covid_DurInf3[[3]] = summariseSimulations_mid(CI = 50,SIMS = epi_aprilDurInf3)
covid_DurInf3[[4]] = summariseSimulations_mid(CI = 50,SIMS = epi_mayDurInf3)
...
AGEcovid_IDurInf3[[3]] = summariseSimulationsAGE(VAR = 'incidence',CI = 50,SIMS = epi_aprilDurInf3)
AGEcovid_IDurInf3[[4]] = summariseSimulationsAGE(VAR = 'incidence',CI = 50,SIMS = epi_mayDurInf3)
...
for(sim in 1:nsim)
{
  ...
  epi_baseDurInf7[[sim]] = simulateOutbreakSEIR(R0t =R0est[sim] ,rho = rep(0.5,3660),dateEndIntenseIntervention = as.Date('2020-04-04'),pWorkOpen = c(0.1,0.75,1,1),
                                                numWeekStagger = c(10/7,10/7,10/7),pInfected=initialI,durInf = durInfSim)
  epi_aprilDurInf7[[sim]] = simulateOutbreakSEIR(R0t =R0est[sim] ,rho = rep(0.5,3660),dateEndIntenseIntervention = as.Date('2020-03-26'),
                                             pInfected=initialI,durInf = durInfSim)
  epi_mayDurInf7[[sim]] = simulateOutbreakSEIR(R0t =R0est[sim] ,rho = rep(0.5,3660),dateEndIntenseIntervention = as.Date('2020-05-26'),
                                             pInfected=initialI,durInf = durInfSim)
  if(sim%%10==0) print(paste0('Done with simulation ',sim))
}
end = Sys.time()
...
covid_SDurInf7[[3]] = summariseSimulations(VAR = 'S',CI = 50,SIMS = epi_aprilDurInf7)
covid_SDurInf7[[4]] = summariseSimulations(VAR = 'S',CI = 50,SIMS = epi_mayDurInf7)
...
covid_IDurInf7[[3]] = summariseSimulations(VAR = 'incidence',CI = 50,SIMS = epi_aprilDurInf7)
covid_IDurInf7[[4]] = summariseSimulations(VAR = 'incidence',CI = 50,SIMS = epi_mayDurInf7)
...
peaktime_DurInf7[[3]] = summarisePeakTimePeakSize(SIMS = epi_aprilDurInf7)
peaktime_DurInf7[[4]] = summarisePeakTimePeakSize(SIMS = epi_mayDurInf7)
...
covid_DurInf7[[3]] = summariseSimulations_mid(CI = 50,SIMS = epi_aprilDurInf7)
covid_DurInf7[[4]] = summariseSimulations_mid(CI = 50,SIMS = epi_mayDurInf7)
...
AGEcovid_IDurInf7[[3]] = summariseSimulationsAGE(VAR = 'incidence',CI = 50,SIMS = epi_aprilDurInf7)
AGEcovid_IDurInf7[[4]] = summariseSimulationsAGE(VAR = 'incidence',CI = 50,SIMS = epi_mayDurInf7)
